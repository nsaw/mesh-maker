...
PRESETS = {
    ...
    'relief-pockets':  {'noise_type':'voronoi-relief', 'frequency':0.10, 'amplitude':4.50, 'noise_exp':1.0, 'peak_exp':1.0, 'valley_exp':1.0, 'valley_floor':0.00, 'offset':0.0, 'octaves':1, 'persistence':0.50, 'lacunarity':2.0, 'distortion':0.4, 'contrast':1.0, 'sharpness':0.00, 'mesh_x':24, 'mesh_y':48, 'smooth_iter':2, 'smooth_str':0.5,
                        'relief_cell_size':4.5, 'relief_jitter':0.8, 'relief_relax_iter':2, 'relief_polarity':'pockets', 'relief_profile':'hemisphere', 'relief_seam_depth':0.22, 'relief_seam_width':0.12, 'relief_anisotropy':0.25, 'relief_anisotropy_angle':75.0, 'relief_attractor_mode':'vertical', 'relief_attractor_x':0.5, 'relief_attractor_y':0.0, 'relief_attractor_radius':0.5, 'relief_attractor_falloff':0.4, 'relief_density_strength':1.4, 'relief_intensity_strength':0.4, 'relief_transition_softness':0.6, 'relief_base_mode':'flat', 'relief_cell_size_gradient':1.3, 'relief_void_strength':0.0, 'relief_attractor_noise':0.6, 'relief_attractor_noise_freq':0.11, 'relief_flow_anisotropy':0.35},
}
