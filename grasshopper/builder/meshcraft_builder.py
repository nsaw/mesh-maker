        ...
        for j in range(rows):
            ...
            for i in range(cols):
                ...
                if wall_frac > 0.0 and crest_w > 1e-6 and db < crest_w:
                    ...
                    crown_mul = 0.35 + 0.65 * cell_depth_mul
