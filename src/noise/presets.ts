...
export const CNC_PRESETS: Record<string, Record<string, string | number>> = {
  ...
  'voronoi-cells': { noiseType:'voronoi', frequency:0.15, amplitude:0.6, noiseExp:0.8, peakExp:1, valleyExp:1, valleyFloor:0, offset:0, octaves:1, persistence:0.5, lacunarity:2, distortion:0, contrast:1, sharpness:0, meshX:36, meshY:24, smoothIter:2, smoothStr:0.6 },
  ...
  'eroded-stone': { noiseType:'ridged', frequency:0.06, amplitude:1.0, noiseExp:0.8, peakExp:1.5, valleyExp:0.4, valleyFloor:0.5, offset:-0.1, octaves:4, persistence:0.5, lacunarity:2.2, distortion:0.35, contrast:1.6, sharpness:0.3, meshX:36, meshY:24, smoothIter:1, smoothStr:0.3 },
};
